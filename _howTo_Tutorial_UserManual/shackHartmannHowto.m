...
- wfs.lenslets.nyquistSampling gives the 2x number of pixels per lo2D; ontrols the angular size of the electric-field pixel
...
%   FoV to half the default value, generating a detector image with hald
%   the number of pixels
%       1.1) enlarge the FoV to have the same output detector pixels: wfs.lenslets.fieldStopSize = 6
%   2) set wfs.lenslets.fieldStopSize = 6; Since the pixel size if 1/2 loD,
